 ...
 */
export const updateEvmAccount = (address, updateEvmAccountBody, options) => {
    return cdpApiClient({
 ...
 */
export const signEvmTypedData = (address, eIP712Message, options) => {
    return cdpApiClient({
 ...
 */
export const importEvmAccount = (importEvmAccountBody, options) => {
    return cdpApiClient({
 ...
 */
export const exportEvmAccount = (address, exportEvmAccountBody, options) => {
    return cdpApiClient({
 ...
 */
export const exportEvmAccountByName = (name, exportEvmAccountByNameBody, options) => {
    return cdpApiClient({
