 ...
 */
import type { ListWebhookSubscriptionsParams, WebhookSubscriptionListResponse, WebhookSubscriptionRequest, WebhookSubscriptionResponse, WebhookSubscriptionUpdateRequest } from "../coinbaseDeveloperPlatformAPIs.schemas.js";
 ...
 */
export declare const listWebhookSubscriptions: (params?: ListWebhookSubscriptionsParams, options?: SecondParameter<typeof cdpApiClient>) => Promise<WebhookSubscriptionListResponse>;
/**
 ...
 */
export declare const createWebhookSubscription: (webhookSubscriptionRequest: WebhookSubscriptionRequest, options?: SecondParameter<typeof cdpApiClient>) => Promise<WebhookSubscriptionResponse>;
/**
 ...
 */
export declare const getWebhookSubscription: (subscriptionId: string, options?: SecondParameter<typeof cdpApiClient>) => Promise<WebhookSubscriptionResponse>;
/**
 ...
 */
export declare const updateWebhookSubscription: (subscriptionId: string, webhookSubscriptionUpdateRequest: WebhookSubscriptionUpdateRequest, options?: SecondParameter<typeof cdpApiClient>) => Promise<WebhookSubscriptionResponse>;
/**
 ...
 */
export declare const deleteWebhookSubscription: (subscriptionId: string, options?: SecondParameter<typeof cdpApiClient>) => Promise<void>;
...
export type UpdateWebhookSubscriptionResult = NonNullable<Awaited<ReturnType<typeof updateWebhookSubscription>>>;
export type DeleteWebhookSubscriptionResult = NonNullable<Awaited<ReturnType<typeof deleteWebhookSubscription>>>;
export {};
