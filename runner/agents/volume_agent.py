...
class VolumeAgent:
    def __init__(self):
        ...
        self.category = keccak_text(self.w3, "volume_data")
    ...
    def tick(self):
        ...
        for job in jobs:
            ...
            tx_hash = self.tx.send(
                ...
                {"job_id": job["id"], "bond_wei": str(bond_wei), "category": "volume"},
            )
            if tx_hash:
                return
        ...
        for job in jobs:
            ...
            tx_hash = self.tx.send(
                ...
                {"job_id": job["id"], "result_uri": result_uri, "category": "volume"},
            )
            if tx_hash:
                return
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                self.logger.log_exception("volume_agent_error", e)
            time.sleep(10)
