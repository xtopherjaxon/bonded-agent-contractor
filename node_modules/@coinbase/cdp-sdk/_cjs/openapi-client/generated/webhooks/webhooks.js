...
exports.deleteWebhookSubscription = exports.updateWebhookSubscription = exports.getWebhookSubscription = exports.createWebhookSubscription = exports.listWebhookSubscriptions = void 0;
...
const listWebhookSubscriptions = (params, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/data/webhooks/subscriptions`, method: "GET", params }, options);
};
...
const getWebhookSubscription = (subscriptionId, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/data/webhooks/subscriptions/${subscriptionId}`, method: "GET" }, options);
};
...
const deleteWebhookSubscription = (subscriptionId, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/data/webhooks/subscriptions/${subscriptionId}`, method: "DELETE" }, options);
};
